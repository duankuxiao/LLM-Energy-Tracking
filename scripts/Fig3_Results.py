...
if __name__ == '__main__':
    ...
    for LLM_policy in ['SDS', 'UGD', 'BCD']:
        if LLM_policy == 'SDS':  # Strict Data Sovereignty
            ...
            infer_ratio_by_country = {'USA': 0.6106, 'Belgium': 0.0000, 'France': 0.0000, 'Sweden': 0.0000, 'Spain': 0.0000, 'Netherlands': 0.0000, 'Germany': 0.0000,
                                      'Italy': 0.0000,
            ...
            infer_ratio_by_country = {"USA": 0.7000, "Belgium": 0.0000, "France": 0.3575, "Sweden": 0.0000, "Spain": 0.0000, "Netherlands": 1.0000, "Germany": 1.0000,
                                      "Italy": 1.0000,
